...
add_filter('gettext_lefcreative-afas-b2b', static function ($translation, $text) {
    ...
    static $fr = [
        // checkout + adresboek (revendeurs, 1 sep 2026)
        'Adres'                      => 'Adresse',
        'Adres aangemaakt.'          => 'Adresse créée.',
        'Adres bewerken'             => 'Modifier l\'adresse',
        'Adres bijgewerkt.'          => 'Adresse mise à jour.',
        'Adresboek'                  => 'Carnet d\'adresses',
        'Adres niet gevonden.'       => 'Adresse introuvable.',
        ...
        'BTW/VAT nummer:'            => 'Numéro de TVA :',
        'BTW/VAT nummer kon niet online geverifieerd worden' => 'Le numéro de TVA n\'a pas pu être vérifié en ligne',
        'bv. NL123456789B01'         => 'p.ex. FR12345678901',
        'Er ging iets mis.'          => 'Une erreur est survenue.',
        'Facturen'                   => 'Factures',
        'Factuuradres'               => 'Adresse de facturation',
        'Factuur %s'                 => 'Facture %s',
        'Factuur %s downloaden (PDF)' => 'Télécharger la facture %s (PDF)',
        'Geldig BTW/VAT nummer'      => 'Numéro de TVA valide',
        'Geverifieerd via VIES'      => 'Vérifié via VIES',
        'Het veld %s is verplicht.'  => 'Le champ %s est obligatoire.',
        'Mislukt.'                   => 'Échec.',
        'Niet gecontroleerd'         => 'Non vérifié',
        '+ Nieuw adres'              => '+ Nouvelle adresse',
        'Nieuw adres'                => 'Nouvelle adresse',
        'Ongeldig BTW/VAT nummer'    => 'Numéro de TVA invalide',
        'Ongeldig volgens VIES'      => 'Invalide selon VIES',
        'Opslaan'                    => 'Enregistrer',
        'Plaats'                     => 'Ville',
        'Postbusadres'               => 'Boîte postale',
        'Postcode'                   => 'Code postal',
        '- Selecteer een afleveradres -' => '- Sélectionnez une adresse de livraison -',
        'Straat'                     => 'Rue',
        'Toevoegen'                  => 'Ajouter',
        'Toevoeging'                 => 'Complément',
        'Track & trace'              => 'Suivi de colis',
        'U heeft geen gekoppeld AFAS account.' => 'Votre compte n\'est pas encore lié à notre administration.',
        'U heeft nog geen adressen.' => 'Vous n\'avez pas encore d\'adresses.',
        'Verbindingsfout.'           => 'Erreur de connexion.',
        'Verbindingsfout. Probeer het opnieuw.' => 'Erreur de connexion. Veuillez réessayer.',
        'verplicht'                  => 'obligatoire',
        'VIES niet beschikbaar bij bestelling' => 'VIES indisponible lors de la commande',
        'Wij konden het adres niet opslaan. Probeer het later opnieuw.' => 'Impossible d\'enregistrer l\'adresse. Veuillez réessayer plus tard.',
        'Wij konden het adres niet opslaan: %s' => 'Impossible d\'enregistrer l\'adresse : %s',
        // mijn account
        'Aantal'                     => 'Quantité',
